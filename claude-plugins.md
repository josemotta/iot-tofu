...
### Example Markdown Skill Definition (loopback4-skill.md)
...
- **Dependency Injection:** Always use constructor injection with `@inject` and `@repository` decorators.
- **REST Conventions:** Follow OpenAPI specs auto-generated by LB4 controller annotations.
...
## Claude Skill profile for LoopBack 4 and MySQL

Below is a complete, custom Claude Skill profile optimized for a new LoopBack 4 and MySQL project. Save this content as .clauderules or loopback4-mysql-skill.md in the root directory of your workspace. When you start a chat, point Claude to this file to instantly align its code generation with LoopBack 4's architecture.
