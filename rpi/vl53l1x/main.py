...
# The VL53L1X qwiic provides a fixed 2K2 pull-up resistor for XSHUT, keeping it high all times.
# Then, GPIO-21 may be released from reset function and can be used for other purposes.
