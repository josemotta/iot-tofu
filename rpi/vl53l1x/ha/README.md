...
The Homeassistant 'distance sensor' includes a rest definition that can be appended to the current Homeassistant configuration using commands shown below:
