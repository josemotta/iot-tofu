...
- hardware based on [Raspberry Pi CM4](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) mounted on the [Tofu board](https://tofu.oratek.com/#/?id=tofu-board), as shown below,
